...
<dl>
 ...
 <dd>- <font color="red">ellos</font> <font color="blue">se</font> llaman...</dd>
  ...
  <hr>
  <p>It is important that we examine the morphology of the language to help develop and lessen mistakes in grammar. In order to understand and learn a language one must conprehend how words are formed and the relationship between them. Conjugation plays a huge role in Spanish, ergo it is essential that we grasp this systematical rule in order to construct well-formed sentences and know the behind those words.</p>
...
<div style="clear:both;">  </div>
   ...
   <p>
<a style="float:left;" href="Gender.html" class="btn2">&#8592; previous page</a>
  <a style="float:right;" href="Phonology.html" class="btn2">next page &#8594;</a>
</p>
<div style="clear:both;">  </div>
